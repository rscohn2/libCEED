...
int CeedElemRestrictionCreate_Hip(CeedMemType mtype,
  ...
  code << restrictionkernels;

  ierr = CeedCompileHip(ceed, code.str().c_str(), &impl->module, 6,
  ...
  ierr = CeedGetKernelHip(ceed, impl->module, "noTrNoTr", &impl->noTrNoTr);
  CeedChk(ierr);
  ierr = CeedGetKernelHip(ceed, impl->module, "noTrTr", &impl->noTrTr);
  CeedChk(ierr);
  ierr = CeedGetKernelHip(ceed, impl->module, "trStrided",
                           &impl->trStrided); CeedChk(ierr);
  ierr = CeedGetKernelHip(ceed, impl->module, "trNoTr", &impl->trNoTr);
  CeedChk(ierr);
  ierr = CeedGetKernelHip(ceed, impl->module, "trTr", &impl->trTr);
  CeedChk(ierr);

  ierr = CeedElemRestrictionSetData(r, (void **)&impl); CeedChk(ierr);
  ierr = CeedSetBackendFunction(ceed, "ElemRestriction", r, "Apply",
                                reinterpret_cast<int (*)()>(CeedElemRestrictionApply_Hip)); CeedChk(ierr);
  ierr = CeedSetBackendFunction(ceed, "ElemRestriction", r, "ApplyBlock",
                                reinterpret_cast<int (*)()>(CeedElemRestrictionApplyBlock_Hip));
  CeedChk(ierr);
  ierr = CeedSetBackendFunction(ceed, "ElemRestriction", r, "Destroy",
                                reinterpret_cast<int (*)()>(CeedElemRestrictionDestroy_Hip)); CeedChk(ierr);
  return 0;
}
